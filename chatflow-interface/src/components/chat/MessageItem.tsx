...
// ⚡ Bolt: Wrapped MessageItem in React.memo to prevent unnecessary re-renders of the chat history.
// Since chat state is managed immutably (e.g. in chat-store.ts), a message's reference won't change
// unless it's updated, making React.memo highly effective here.
