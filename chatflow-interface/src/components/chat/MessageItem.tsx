...
// ⚡ Bolt: Wrapped MessageItem in React.memo() to prevent unnecessary re-renders of unchanged chat messages.
// This significantly improves rendering performance of the dynamic chat message list history.
