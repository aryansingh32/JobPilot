...
// ⚡ Bolt: Adding React.memo prevents unnecessary re-renders of previous messages
// when new messages are added to the list. This relies on the chat-store's
// immutable state updates for performance gains.
