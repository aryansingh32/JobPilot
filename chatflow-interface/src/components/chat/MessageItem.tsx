...
// ⚡ Bolt Optimization: Added React.memo to prevent unnecessary re-renders of the entire
// chat history list when new messages are added, taking advantage of the immutable chat state.
